                ...
                <div className="mx-auto container relative z-20 lg:px-0 px-4">
                    <div className="flex lg:flex-row flex-col-reverse items-center justify-between lg:mt-24">
                        <div className="lg:w-1/2">
                            ...
                            <h1 className="lg:text-2xl text-lg text-color-gray lg:leading-8 leading-6 mt-6 border-l-8 border-color-orange lg:pl-12 pl-2 py-2">American style eatery located in the heart of downtown San
                    Luis Obispo, CA focused on delivering restorative justice to
                    the community via culinary excellence. Join our mailing list below to stay up to
                    date!.</h1>
                            <div className="flex items-center justify-center mt-12">
                                ...
                                <button className="xl:py-5 py-2 xl:px-16 px-6 border-color-orange 2xl:text-3xl lg:text-xl text-base font-semibold leading-loose text-color-orange focus:outline-none button-transparent border-2 border-color-orange b-r-10">Join Mailing List</button>
                            </div>
                        ...
                        <div className=" scale-150 lg:w-1/2 height-main-hero xl:block hidden">
                            <img loading="lazy" src="https://i.ibb.co/qRq3XKm/hero1.png" className="w-full scale-150" />
                        </div>
