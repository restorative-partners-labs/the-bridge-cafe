        ...
        <div className="lg:mt-16 mt-8 lg:flex items-end">
          ...
          <div className="lg:w-1/2">
            <div className="lg:pb-24 lg:pl-24 lg:pt-0 pt-8">
              <div>
                <p className="text-2xl font-semibold">The Bridge Cafe</p>
                <p className="text-lg pt-5">
                  1074 Higuera St, San Luis Obispo, CA 93401
                </p>
                <p className="text-lg pt-1">info@thebridgecafe.org</p>
              </div>
              <div className="lg:pt-24 pt-8">
                <p className="text-2xl font-semibold">Restorative Partners</p>
                <p className="text-lg pt-5">
                3196 S. Higuera St, Suite D, San Luis Obispo, CA 93401
                </p>
                <p className="text-lg pt-1">805-242-1272</p>
                <p className="text-lg pt-1">info@restorativepartners.org</p>
              </div>
            </div>
          </div>
        </div>
